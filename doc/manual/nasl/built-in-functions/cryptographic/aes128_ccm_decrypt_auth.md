...
**aes128_ccm_decrypt_auth** - decrypts given data including a authentication token with AES 128 CCM mode.

## SYNOPSIS

*str* **aes128_ccm_decrypt_auth**(key:str, iv: str, data: str, aad: str, len: int);

**aes128_ccm_decrypt_auth** decrypts given data including a authentication token with AES 128 CCM mode.

## DESCRIPTION
decrypt the given data using the AES 128 bit algorithm in CCM mode including an authentication token given via aad.
