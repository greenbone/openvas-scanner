...
**dump_icmp_packet** - Prints the ICMP part of datagrams.

## SYNOPSIS

*any* **dump_icmp_packet**(*string*, ...);

**dump_icmp_packet** It takes any number of unnamed (string) arguments.


## DESCRIPTION

Receive a list of IP datagrams and print their ICMP part in a readable format in the screen.
