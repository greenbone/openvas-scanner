...
i64_to_enum! {
    pub enum OpenvasEncaps {
        ...
        Ip,
        Sslv23, /* Ask for compatibility options */
        Sslv2,
        Sslv3,
        Tlsv1,
        Tlsv11,
...
impl Display for OpenvasEncaps {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            OpenvasEncaps::Sslv23 => write!(f, "SSL 2.3"),
            OpenvasEncaps::Sslv2 => write!(f, "SSL 2"),
            OpenvasEncaps::Sslv3 => write!(f, "SSL 3"),
            OpenvasEncaps::Tlsv1 => write!(f, "TLS 1"),
            OpenvasEncaps::Tlsv11 => write!(f, "TLS 1.1"),
            OpenvasEncaps::Tlsv12 => write!(f, "TLS 1.2"),
            OpenvasEncaps::Tlsv13 => write!(f, "TLS 1.3"),
            _ => write!(f, "unknown"),
        }
    }
}
...
impl OpenvasEncaps {
    pub fn to_priority(&self) -> &str {
        match self {
            OpenvasEncaps::Auto => "",
            OpenvasEncaps::Ip => "",
            OpenvasEncaps::Sslv23 => {
                // Compatability mode
                "NORMAL:-VERS-TLS-ALL:+VERS-TLS1.0:+VERS-SSL3.0:+ARCFOUR-128:%COMPAT"
            }
            OpenvasEncaps::Sslv2 => "",
            OpenvasEncaps::Sslv3 => "NORMAL:-VERS-TLS-ALL:+VERS-SSL3.0:+ARCFOUR-128:%COMPAT",
            OpenvasEncaps::Tlsv1 => "NORMAL:-VERS-TLS-ALL:+VERS-TLS1.0:+ARCFOUR-128:%COMPAT",
            OpenvasEncaps::Tlsv11 => "NORMAL:-VERS-TLS-ALL:+VERS-TLS1.1:+ARCFOUR-128:%COMPAT",
            OpenvasEncaps::Tlsv12 => "NORMAL:-VERS-TLS-ALL:+VERS-TLS1.2:+ARCFOUR-128:%COMPAT",
            OpenvasEncaps::Tlsv13 => "NORMAL:-VERS-TLS-ALL:+VERS-TLS1.3:%COMPAT",
            OpenvasEncaps::Tlscustom => "",
            OpenvasEncaps::Max => "",
        }
    }
}
