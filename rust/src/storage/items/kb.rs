...
pub enum KbKey {
    ...
    // FindService
    FindServiceCnxTime1000(u16),
    FindServiceCnxTime(u16),
    FindServiceRwTime1000(u16),
    FindServiceRwTime(u16),
    FindServiceTcpGetHttp(u16),
    FindServiceTcpSpontaneous(u16),
    KnownTcp(u16),

    // Connect
    /// Number of timeouts for a given IP address and port. After a failed attempt
    /// this number is increased by 1 and logged.
    ConnectTimeout(IpAddr, u16),
