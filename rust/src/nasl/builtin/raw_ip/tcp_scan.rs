...
async fn plugin_run_openvas_tcp_scanner(
    ...
    set_rtt_stats(script_ctx, &results.rtt_stats[0], "unfiltered").await?;
    set_rtt_stats(script_ctx, &results.rtt_stats[1], "open").await?;
    set_rtt_stats(script_ctx, &results.rtt_stats[2], "closed").await?;
