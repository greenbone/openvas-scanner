...
fn nasl_hash<D: Digest>(register: &Register) -> Result<NaslValue, NaslError>
where
...
pub fn hash_md2(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
    nasl_hash::<Md2>(register)
}

/// NASL function to get MD4 hash
pub fn hash_md4(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
    nasl_hash::<Md4>(register)
}

/// NASL function to get MD5 hash
pub fn hash_md5(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
    nasl_hash::<Md5>(register)
}

/// NASL function to get SHA1 hash
pub fn hash_sha1(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
    nasl_hash::<Sha1>(register)
}

/// NASL function to get SHA256 hash
pub fn hash_sha256(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
    nasl_hash::<Sha256>(register)
}

/// NASL function to get SHA512 hash
pub fn hash_sha512(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
    nasl_hash::<Sha512>(register)
}

/// NASL function to get RIPemd160 hash
pub fn hash_ripemd160(register: &Register, _: &Context) -> Result<NaslValue, NaslError> {
