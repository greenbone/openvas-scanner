    ...
    fn forge_packet() {
        ...
        nasl_test_custom_context! {
            ...
            r#"ip_packet = forge_ip_packet(ip_v : 4,
                        ...
                        ip_src : 192.168.0.1,
                        ip_dst : 192.168.0.12);"#
                == vec![69, 0, 0, 20, 210, 4, 0, 0, 255, 6, 104, 129, 192, 168, 0, 1, 192, 168, 0, 12],
            r#"tcp_packet = forge_tcp_packet(ip:       ip_packet,
                                ...
                                th_sum:   0,
                                th_urp:   0);"#
                == vec![69, 0, 0, 40, 210, 4, 0, 0, 255, 6, 104, 109, 192, 168, 0, 1, 192, 168, 0, 12, 19, 216, 0, 80, 0, 0, 3, 232, 0, 0, 0, 0, 80, 33, 0, 0, 22, 86, 0, 0],
        }
    }
