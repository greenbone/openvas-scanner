...
mod tests {
    ...
    fn aes128_gcm_crypt() {
        nasl_test! {
            r#"key = hexstr_to_data("7fddb57453c241d03efbed3ac44e371c");"#,
            r#"data = hexstr_to_data("d5de42b461646c255c87bd2962d3b9a2");"#,
            r#"iv = hexstr_to_data("ee283a3fc75575e33efd4887");"#,
    ...
    fn aes128_gcm_crypt_auth() {
        nasl_test! {
            r#"key = hexstr_to_data("c939cc13397c1d37de6ae0e1cb7c423c");"#,
            r#"data = hexstr_to_data("c3b3c41f113a31b73d9a5cd432103069");"#,
            r#"iv = hexstr_to_data("b3d8cc017cbb89b39e0f67e2");"#,
            r#"aad = hexstr_to_data("24825602bd12a984e0092d3e448eda5f");"#,
    ...
    fn aes192_gcm_crypt() {
        nasl_test! {
            r#"key = hexstr_to_data("fbc0b4c56a714c83217b2d1bcadd2ed2e9efb0dcac6cc19f");"#,
            r#"data = hexstr_to_data("d2ae38c4375954835d75b8e4c2f9bbb4");"#,
            r#"iv = hexstr_to_data("5f4b43e811da9c470d6a9b01");"#,
    ...
    fn aes192_gcm_crypt_auth() {
        nasl_test! {
            r#"key = hexstr_to_data("6f44f52c2f62dae4e8684bd2bc7d16ee7c557330305a790d");"#,
            r#"data = hexstr_to_data("37222d30895eb95884bbbbaee4d9cae1");"#,
            r#"iv = hexstr_to_data("9ae35825d7c7edc9a39a0732");"#,
            r#"aad = hexstr_to_data("1b4236b846fc2a0f782881ba48a067e9");"#,
    ...
    fn aes256_gcm_crypt() {
        nasl_test! {
            r#"key = hexstr_to_data("31bdadd96698c204aa9ce1448ea94ae1fb4a9a0b3c9d773b51bb1822666b8f22");"#,
            r#"data = hexstr_to_data("2db5168e932556f8089a0622981d017d");"#,
            r#"iv = hexstr_to_data("0d18e06c7c725ac9e362e1ce");"#,
    ...
    fn aes256_gcm_crypt_auth() {
        nasl_test! {
            r#"key = hexstr_to_data("92e11dcdaa866f5ce790fd24501f92509aacf4cb8b1339d50c9c1240935dd08b");"#,
            r#"data = hexstr_to_data("2d71bcfa914e4ac045b2aa60955fad24");"#,
            r#"iv = hexstr_to_data("ac93a1a6145299bde902f21a");"#,
            r#"aad = hexstr_to_data("1e0889016f67601c8ebea4943bc23ad6");"#,
