...
pub fn hmac_md2<K,S>(register: &Register, _: &Context<K,S>) -> Result<NaslValue, FunctionErrorKind> {
    hmac::<Md2>(register)
}

/// NASL function to get HMAC MD5 string
pub fn hmac_md5<K,S>(register: &Register, _: &Context<K,S>) -> Result<NaslValue, FunctionErrorKind> {
    hmac::<Md5>(register)
}

/// NASL function to get HMAC RIPEMD160 string
pub fn hmac_ripemd160<K,S>(
    register: &Register,
    _: &Context<K,S>,
...
pub fn hmac_sha1<K,S>(register: &Register, _: &Context<K,S>) -> Result<NaslValue, FunctionErrorKind> {
    hmac::<Sha1>(register)
}

/// NASL function to get HMAC SHA256 string
pub fn hmac_sha256<K,S>(register: &Register, _: &Context<K,S>) -> Result<NaslValue, FunctionErrorKind> {
    hmac::<Sha256>(register)
}

/// NASL function to get HMAC SHA384 string
pub fn hmac_sha384<K,S>(register: &Register, _: &Context<K,S>) -> Result<NaslValue, FunctionErrorKind> {
    hmac::<Sha384>(register)
}

/// NASL function to get HMAC SHA512 string
pub fn hmac_sha512<K,S>(register: &Register, _: &Context<K,S>) -> Result<NaslValue, FunctionErrorKind> {
